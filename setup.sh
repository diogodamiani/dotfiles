...
DOTFILES_DIR_backup=$DOTFILES_DIR"_old"           

# Create dotfiles_old in homedir
echo -n "Creating $DOTFILES_DIR_backup for backup of any existing dotfiles in ~..."
...
for i in ${FILES_TO_SYMLINK[@]}; do
  echo "Moving any existing dotfiles from ~ to $DOTFILES_DIR_backup"
  mv ~/.${i##*/} $DOTFILES_DIR_backup
done
...
main() {
  ...
  ln -fs $DOTFILES_DIR/lib/online-check.sh $HOME/.online-check.sh
